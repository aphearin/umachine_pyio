...
parser.add_argument("output_dirname", help="Directory to store the Numpy binary files")
parser.add_argument("scale_factor", help="Scale factor of the history files.")
parser.add_argument("log_sm_cut", type=float, help="log10(M*_min/Msun)")
...
parser.add_argument(
    ...
    default=".txt",
    help="Concluding substring used to identify the ascii files in the input directory."
    "Default is ``.txt``",
)
parser.add_argument(
    "-subvolume_labels",
    ...
    nargs="+",
    default="-1",
    help="Sequence of integers of subvolumes to process. Default is to process all.",
)
parser.add_argument(
    "-galaxy_colnames",
    type=str,
...
print(
    "\n...creating binary reductions for scale factor = {0}".format(args.scale_factor)
)
